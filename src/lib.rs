...
pub type projectm_settings = ffi::projectm_settings_s;
...
impl projectm {
    ...
    // pub fn set_preset_switch_requested_event_callback(instance: projectm_handle, callback: preset_switch_requested_event, user_data: *mut ()) {
    //     unsafe { ffi::projectm_set_preset_switch_requested_event_callback(instance, callback, user_data as *mut ::std::os::raw::c_void) };
    // }

    // pub fn set_preset_switch_failed_event_callback(instance: projectm_handle, callback: preset_switch_failed_event, user_data: *mut ()) {
